...
export default function Profile() {
  return (
    <div className="py-12">
      <div className="container flex items-start gap-6 flex-wrap xl:flex-nowrap">
        <div className="flex items-start gap-6 w-full md:flex-nowrap flex-wrap justify-center">
          <div className="md:max-w-[300px] w-full dark:bg-inherit dark:border bg-slate-50 rounded-md">
            <ProfileForm />
          </div>
          <ProfileSciences />
        </div>
